...
KOREAN_STOP_WORDS = [
    '의', '가', '이', '은', '는', '을', '를', '에', '에서', '과', '와', '으로', '로',
    '도', '만', '의해', '에게', '한테', '께서', '그', '저', '이것', '그것',
    '저것', '이런', '저런', '그런', '있다', '되다', '하다'
]
...
def extract_keywords(text, max_tags= 10, lang='ko'):
    ...
    if lang == 'ko':
        ...
        candidate_keywords = [(word, score) for word, score in raw_keywords if word.lower() not in stop_words]
